...
def validarEntradaNumAst(cadena):
    ...
    if (cadena==""):
        ...
        if(validarEntradaCifradoTelefonico(cadena)==-1):
            return -3
...
def validarEntradaCifradoTelefonico(cadena):
    ...
    if(len(cadena)%2!=0):
        ...
        while (cadena != ""):
            ...
            if(buscarCaracter("10", parNumeros[0])!=-1 or buscarCaracter("0", parNumeros[1])!=-1):
                return -1
