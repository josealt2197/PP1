        ...
        if (opcion == 1):
            ...
            if(resultadoEntrada=="-1"):       
                ...
                if(resultadoClave=="-1"):       
                    ...
                    print("\n*** Se ha producido un ERROR: La clave SOLO debe contener DOS numeros enteros entre 0 y 9 ***\n")
                    menuDescifrado()
                else:
    ...
    while(opcion!=9):
        ...
        if (opcion == 1):
            ...
            if(resultadoEntrada=="-1"):       
                ...
                resultadoClave = validarClaveRSA()
                if(resultadoClave=="-1"):       
